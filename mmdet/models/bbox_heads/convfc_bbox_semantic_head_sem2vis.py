...
class ConvFCSemanticBBoxHead_SEM2VIS(BBoxSemanticHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCSemanticBBoxHead_SEM2VIS, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        super(ConvFCSemanticBBoxHead_SEM2VIS, self).init_weights()
...
@HEADS.register_module
class SharedFCSemanticBBoxHead_SEM2VIS(ConvFCSemanticBBoxHead_SEM2VIS):

    def __init__(self, num_fcs=2, fc_out_channels=1024, *args, **kwargs):
        assert num_fcs >= 1
        super(SharedFCSemanticBBoxHead_SEM2VIS, self).__init__(
            num_shared_convs=0,
